...
public class AppRestController {
    ...
    public RedirectView processForm1() {
        ...
        String url = "https://praneethjayawickrama.auth0.com/authorize"+
                    "?audience=https://praneethjayawickrama.auth0.com/api/v2/"+
                    "&scope=openid%20profile"+
                    "&response_type=code"+
                    "&client_id=F7vGcZJAJjHHxRcN4OprsywGPeRPKeet"+
                    "&redirect_uri=http%3A%2F%2Flocalhost%3A8888%2Foauth%2Faccess"+
                    "&state=123";
    ...
    public String getAuthResponse(String authCode)
    {
        ...
        //OAuth Token URL
        String auth_url = "https://praneethjayawickrama.auth0.com/oauth/token";
        
        //Prepare POST Request Body
        String POST_PARAMS = "grant_type=authorization_code"+
                            "&client_id=F7vGcZJAJjHHxRcN4OprsywGPeRPKeet"+
                            "&client_secret=14emCVbuz78VArCUMrbNCQJg7abb8Z2g8KeZW2qo-uyo9OUviuyb5EgavwIRkR3t"+
                            "&code="+authCode+
                            "&redirect_uri=http%3A%2F%2Flocalhost%3A8888%2Foauth%2Faccess";
        String authReponse = "";
